...
use App\Jobs\AfterShopifyAuthentication;
...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'EFRIS Shopify App'),
    ...
    */
    ...
    'after_authenticate_job' => [
        [
            'job' => env('AFTER_AUTHENTICATE_JOB', AfterShopifyAuthentication::class), // example: \App\Jobs\AfterAuthorizeJob::class
